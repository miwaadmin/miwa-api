      ...
      <header className="pt-32 pb-12 px-6" style={{ background: '#fafafa', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base text-zinc-500 mt-6">
            ...
            <span className="font-semibold">Last updated:</span> April 16, 2026
          </p>
        </div>
      </header>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Section title="2. Scope of this policy" id="scope">
            ...
            <p>
              ...
              We process PHI only under the therapist's direction, governed by a Business Associate Agreement (BAA) established
              at account creation.
            </p>
          </Section>
          ...
          <Section title="3. Information we collect" id="collect">
            ...
            <ul className="space-y-2">
              ...
              <Bullet><strong>Voice recordings:</strong> if the therapist uses session recording features, audio is transcribed and then <strong>permanently deleted</strong> within 24 hours unless the therapist explicitly elects to retain it.</Bullet>
            </ul>
          ...
          <Section title="4. How we use information" id="use">
            <ul className="space-y-2">
              ...
              <Bullet>Deliver SMS reminders and assessment links to patients on the therapist's behalf.</Bullet>
              ...
              <Bullet>Comply with legal obligations, including HIPAA-required audit logging.</Bullet>
            </ul>
            <p className="mt-4">
              ...
              <table className="w-full text-base">
                ...
                <tbody className="divide-y divide-zinc-100">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-zinc-600">SMS delivery (appointment reminders, assessment links)</td>
                    <td className="px-4 py-3 text-zinc-600">Yes — under BAA</td>
                  </tr>
                  <tr>
          ...
          <Section title="6. HIPAA notice" id="hipaa">
            ...
            <p className="mt-4">
              A <strong>Business Associate Agreement</strong> is executed with each therapist as part of account creation.
          ...
          <Section title="7. Data security" id="security">
            ...
            <ul className="space-y-2">
              ...
              <Bullet><strong>Encryption at rest:</strong> AES-256 on all databases, backups, and file storage.</Bullet>
              <Bullet><strong>Authentication:</strong> Password hashing with industry-standard algorithms; optional multi-factor authentication.</Bullet>
              ...
              <Bullet><strong>Audit logging:</strong> All access to PHI is logged with user, timestamp, and action for at least six years, meeting HIPAA retention requirements.</Bullet>
              <Bullet><strong>Hosting:</strong> HIPAA-eligible infrastructure with a signed BAA.</Bullet>
          ...
          <Section title="8. Data retention" id="retention">
            <ul className="space-y-2">
              ...
              <Bullet><strong>Audit logs:</strong> Retained for a minimum of 6 years per HIPAA § 164.316(b)(2)(i).</Bullet>
              <Bullet><strong>Voice recordings:</strong> Deleted within 24 hours of transcription unless the therapist explicitly retains them.</Bullet>
              <Bullet><strong>Backups:</strong> Rolling 35-day retention, then permanent deletion.</Bullet>
            </ul>
          </Section>
