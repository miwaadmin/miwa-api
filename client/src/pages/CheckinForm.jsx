/**
 * Public between-session check-in form.
 *
 * This page is intentionally mobile-first because most clients open it from
 * an SMS or email link. Keep the shell component outside the form component so
 * typing notes does not remount the textarea and drop the mobile keyboard.
 */
...
export default function CheckinForm() {
  ...
  useEffect(() => {
    fetch(`${API}/public/checkin/${token}`)
      ...
      .catch(() => {
        setState('error')
        setErrorMsg('Could not load your check-in. Please try again.')
      })
  }, [token])
            ...
            <div className="mt-6 rounded-2xl border border-red-200 bg-red-50 p-4 max-w-md text-left">
              ...
              <div className="space-y-2">
                <a href="tel:988" className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-white border border-red-200 active:bg-red-50 min-h-[44px]">
                  ...
                  <span className="text-sm text-red-900">Suicide and Crisis Lifeline</span>
                </a>
    ...
    <Shell>
      <div className="flex-1 flex flex-col px-6 py-8 max-w-md w-full mx-auto">
        <div className="text-center mb-6">
          <div
            className="w-12 h-12 rounded-2xl mx-auto flex items-center justify-center text-white text-lg font-bold shadow-md mb-4"
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            autoCorrect="on"
            spellCheck="true"
            className="w-full rounded-xl px-4 py-3 text-base leading-6 bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-400/40 focus:border-brand-400 resize-none"
          />
