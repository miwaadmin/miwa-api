...
const STATUS_STYLES = {
  completed: { bg: 'bg-emerald-50', border: 'border-emerald-200', text: 'text-emerald-700', icon: 'âœ“' },
  running: { bg: 'bg-indigo-50', border: 'border-indigo-200', text: 'text-indigo-700', icon: 'âŸ³' },
  pending: { bg: 'bg-gray-50', border: 'border-gray-200', text: 'text-gray-400', icon: 'â-‹' },
  failed: { bg: 'bg-red-50', border: 'border-red-200', text: 'text-red-700', icon: 'âœ-' },
  awaiting_approval: { bg: 'bg-amber-50', border: 'border-amber-200', text: 'text-amber-700', icon: 'â¸' },
}
