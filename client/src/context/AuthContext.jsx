...
export function AuthProvider({ children }) {
  ...
  // Auto-logout after an inactivity window. Defaults to 60 minutes for safety;
  // deployments can adjust this with VITE_IDLE_TIMEOUT_MINUTES when policy requires it.
